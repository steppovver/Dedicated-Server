...
public class Server
{
    ...
    public static List<int> clientOrder = new List<int>();
    ...
    public static void Start(int _maxPlayers, int _port)
    {
        ...
        Debug.Log($"Server is started om {Port}");
    }
    ...
    public static void SendUDPData(IPEndPoint _clientEndPoint, Packet _packet)
    {
        ...
        {
            Debug.Log($"Error sending data to {_clientEndPoint} vid UDP: {_ex}");
        }
    }
        ...
        packetHandlers = new Dictionary<int, PacketHandler>()
            {
                ...
                { (int)ClientPackets.rollDice, ServerHandle.RollADice },
                { (int)ClientPackets.gameIsReady, ServerHandle.GameIsReady },
            };
